-- Script final para corrigir triggers do checklist
...
DROP FUNCTION IF EXISTS trigger_criar_checklist_automatico();
DROP FUNCTION IF EXISTS trigger_checklist_update_status_voo();
DROP FUNCTION IF EXISTS trigger_checklist_validation();

-- Recriar função para popular checklist automaticamente quando voo é criado
