...
-- Esta query deve mostrar a coluna updated_at:
-- SELECT column_name, data_type, is_nullable FROM information_schema.columns WHERE table_name = 'checklist_itens' AND column_name = 'updated_at';