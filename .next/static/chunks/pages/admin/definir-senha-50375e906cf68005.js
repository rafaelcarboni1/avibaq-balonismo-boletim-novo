...
to {
  ...
  animation: ${M} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,H=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?i.createElement(V,null,t):t:"blank"===a?null:i.createElement(q,null,i.createElement(I,{...r}),"loading"!==a&&i.createElement(Z,null,"error"===a?i.createElement(G,{...r}):i.createElement(T,{...r})))},X=e=>`
...
`,Q=(e,t)=>{let a=e.includes("top")?1:-1,[r,s]=k()?["0%{opacity:0;} 100%{opacity:1;}","0%{opacity:1;} 100%{opacity:0;}"]:[X(a),Y(a)];return{animation:t?`${w(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${w(s)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}};i.memo(({toast:e,position:t,style:a,children:r})=>{let s=e.height?Q(e.position||t||"top-center",e.visible):{opacity:0},o=i.createElement(H,{toast:e}),n=i.createElement(K,{...e.ariaProps},D(e.message,e));return i.createElement(J,{className:e.className,style:{...s,...a,...e.style}},"function"==typeof r?r({icon:o,message:n}):i.createElement(i.Fragment,null,o,n))}),o=i.createElement,m.p=void 0,x=o,y=void 0,v=void 0,b`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`}},function(e){e.O(0,[9332,4958,2888,9774,179],function(){return e(e.s=37043)}),_N_E=e.O()}]);