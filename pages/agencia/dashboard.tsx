        ...
        <BentoGrid className="grid-cols-2 lg:grid-cols-4 gap-6">
          <BentoGridItem className="bg-slate-50 border border-blue-100">
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-700">Total Pilotos</p>
                  <NumberTicker 
          ...
          <BentoGridItem className="bg-slate-50 border border-green-100">
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-green-700">Pilotos Ativos</p>
                  <NumberTicker 
          ...
          <BentoGridItem className="bg-slate-50 border border-purple-100">
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-700">Voos Este Ano</p>
                  <NumberTicker 
          ...
          <BentoGridItem className="bg-slate-50 border border-amber-100">
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-amber-700">Voos Este Mês</p>
                  <NumberTicker 
