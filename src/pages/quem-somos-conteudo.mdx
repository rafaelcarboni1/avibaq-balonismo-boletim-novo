{/* Forçando alteração para commit e push */}
import PageLayout from "@/components/PageLayout";

export default function QuemSomos() {
  return (
    <PageLayout>
      <article className="prose prose-slate max-w-4xl mx-auto px-4 sm:px-0 space-y-6 [&_h2]:mt-10 [&_h2]:mb-4 [&_h3]:mt-8 [&_h3]:mb-3">
        ...
        <h2>Associe-se</h2>
        <p>Pilotos, instrutores e empresas de balonismo que operam em Praia Grande/SC podem solicitar filiação enviando e-mail para <strong>contato@avibaq.org</strong>. Os associados têm acesso a treinamentos exclusivos, material didático e participação nas reuniões da entidade.</p>
