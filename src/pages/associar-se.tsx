...
export default function AssociarSe() {
  ...
  function validarCampos() {
    ...
    if (tipo === "piloto" && !form.cpf) return "Informe o CPF.";
    if (tipo === "agencia" && !form.cnpj) return "Informe o CNPJ.";
  ...
  function handleSubmit(e) {
    ...
    alert("Formulário validado! (integração na próxima etapa)");
  }
            ...
            <>
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <input name="qtd_baloes" type="number" value={form.qtd_baloes} onChange={handleChange} className="input w-full" />
                </div>
                <div className="flex-1">
