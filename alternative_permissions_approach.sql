-- ABORDAGEM ALTERNATIVA: Função com nome diferente para evitar conflitos
CREATE OR REPLACE FUNCTION get_combined_user_permissions_v2(p_user_id UUID)
RETURNS TABLE (
  recurso text,
  acao text,
  permitido boolean,
...
GRANT EXECUTE ON FUNCTION get_combined_user_permissions_v2(UUID) TO authenticated;